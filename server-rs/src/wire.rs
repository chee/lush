//! Wire message enum multiplexing sync and ephemeral traffic over a single
//! connection. Decode reads the 4-byte schema header and dispatches; keyhive
//! (`SUK\x00`) is not spoken here.
